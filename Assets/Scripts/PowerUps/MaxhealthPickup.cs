...
public class MaxHealthPickup : MonoBehaviour
{
    ...
    [SerializeField] private int maxHealthIncrease = 30; // Incremento de vida máxima.
    ...
    private void CheckCollision()
    {
        foreach (GameObject player in GameObject.FindGameObjectsWithTag("Player"))
        {
            ...
            {
                IncreaseMaxHealthOnly(playerView);
                DestroyPickup();
                return;
            }
        }
    ...
    private void IncreaseMaxHealthOnly(PhotonView targetView)
    {
